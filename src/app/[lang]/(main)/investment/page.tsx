...
const pageContent = {
  en: (
    <>
      <div>
        <h2 className="mb-5 text-2xl font-bold">Investment</h2>
  ...
  hy: (
    <>
      <div>
        <h2 className="mb-5 text-2xl font-bold">Ներդրում</h2>
        <p className="font-[600]">
          Անշարժ գույքում ներդրումները հայտնի ռազմավարություն են հարստություն
          ...
          լինի դա վարձակալության, գույքի արժևորման կամ երկուսի միջոցով։ Ահա որոշ
          կարևոր կետեր, որոնք պետք է հաշվի առնել անշարժ գույքում ներդրումներ
          կատարելիս:
        </p>
      </div>
      <div className="mt-10">
        ...
        <ol className="list-decimal space-y-3 ps-5 font-[500]">
          <li>
            Բնակելի Գույքեր: Դրանք ներառում են մեկ ընտանիքի տներ, երկտնային տներ
            և բազմաբնակարանային շենքեր։ Ներդրողները կարող են եկամուտ ստանալ այս
            գույքերը վարձակալության տալով:
          </li>
          <li>
            Առևտրային Գույքեր: Դրանք ներառում են գրասենյակային շենքեր, մանրածախ
            տարածքներ, պահեստներ և արդյունաբերական գույքեր։ Առևտրային անշարժ
            գույքը կարող է առաջարկել ավելի բարձր վարձակալական եկամուտ և ավելի
            երկարաժամկետ պայմանագրեր։
          </li>
          <li>
            Հանգստյան Տներ: Տուրիստական վայրերում գույքերը կարող են եկամուտ
            ստանալ կարճաժամկետ վարձակալություններով։ Այս շուկան զգալիորեն աճել է
            այնպիսի հարթակների միջոցով, ինչպիսին է Airbnb-ն։
          </li>
          <li>
            Անշարժ Գույքի Ներդրումային Հիմնադրամներ (REITs): Դրանք
            ընկերություններ են, որոնք ունեն, աշխատեցնում կամ ֆինանսավորում են
            եկամուտ ստեղծող անշարժ գույք։ Ներդրողները կարող են գնել բաժնետոմսեր
            այս հիմնադրամներում՝ ներդրում կատարելու հնարավորություն ստանալով
            առանց անմիջականորեն գույքերի գնման:
          </li>
          <li>
            Հող: Ներդրումները չզարգացած հողում կարող են լինել շահավետ, եթե
      ...
      <div className="mt-10">
        ...
        <ul className="list-disc space-y-3 ps-5 font-[500]">
          <li>
            ...
            հաստատուն և հուսալի եկամտի աղբյուր:
          </li>
          <li>
          ...
          <li>
            Լծակավորում: Անշարժ գույքը թույլ է տալիս ներդրողներին օգտագործել
            փոխառված միջոցներ՝ պոտենցիալ վերադարձները մեծացնելու համար, ինչը
            հայտնի է որպես լծակավորում:
          </li>
        </ul>
      </div>
      <div className="mt-10">
  ...
  rus: (
    <>
      <div>
        <h2 className="mb-5 text-2xl font-bold">Инвестиции</h2>
        <p className="font-[600]">
      ...
      <div className="mt-10">
        ...
        <ol className="list-decimal space-y-3 ps-5 font-[500]">
          <li>
            Жилая недвижимость: Сюда входят одно-, двух- и многоквартирные дома.
            Инвесторы могут получать доход, сдавая эти объекты в аренду.
          </li>
          <li>
            Коммерческая недвижимость: Включает офисные здания, торговые
            помещения, склады и промышленные объекты. Коммерческая недвижимость
            может приносить более высокий арендный доход и предлагать более
            долгосрочные договоры аренды.
          </li>
          <li>
            Вакансионная недвижимость: Недвижимость в туристических местах может
            приносить доход за счет краткосрочной аренды. Этот рынок значительно
            вырос благодаря таким платформам, как Airbnb.
          </li>
          <li>

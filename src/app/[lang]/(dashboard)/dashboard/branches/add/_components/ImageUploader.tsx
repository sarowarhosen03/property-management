...
const ImageUploader = forwardRef<HTMLInputElement, ImageUploaderProps>(
  ({ className, fieldName, i18Data }, ref) => {
    ...
    return (
      <>
        <div
          {...getRootProps({
            className: cn(
              "dropzone p-4 border-2 border-dashed border-seondary rounded-md h-[214px] flex items-center justify-center bg-secondary-100 w-full",
              className,
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-lg font-semibold">{i18Data.DropOrUploadPhoto}</p>
          </div>
        </div>
